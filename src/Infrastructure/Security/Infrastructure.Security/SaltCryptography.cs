...
namespace Infrastructure.Security
{
    ...
    /// </summary>
    public sealed class SaltCryptography
    {
        /// <summary>
        ...
        {
            return CreatePassword(password, CryptoType.MD5.ToString(), null);
        }
        private static string CreatePassword(string password, string hashAlgorithm, byte[] saltBytes)
        {
        ...
        {
            return VerifyPassword(password, CryptoType.MD5.ToString(), hash);
        }
        private static bool VerifyPassword(string password, string hashAlgorithm, string hash)
        {
            ...
            string expectedHashString = CreatePassword(password, hashAlgorithm, saltBytes);
